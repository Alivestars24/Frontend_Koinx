...
export const Aside = () => {
  ...
  return (
    <section className="flex flex-col gap-5 lg:min-w-1/3 w-full">
                ...
                >
                  <div className="flex justify-between">
                    <div className="flex gap-[6px]">
                      ...
                      <p className="tex-base leading-6 text-xs font-bold text-[var(--black)]">
                        {coin?.item?.name}({coin?.item?.symbol})
                      </p>
                    </div>
                    <div
                      className={cn(
                        'py-[1.5px] max-w-[90px] w-full flex items-center justify-center gap-[5.5px] rounded',
