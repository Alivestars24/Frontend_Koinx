                ...
                {coins?.map((coin) => {
                  ...
                  return (
                    <div
                      ...
                      className="rounded-[10px] border border-[#E3E3E3] py-2 px-[17px] max-w-[232px] w-full flex flex-col flex-shrink-0 gap-1"
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          > 
                            <p>{coin?.item?.data?.price_change_percentage_24h?.btc.toFixed(
                              2,
                            )}
                            %</p>
                          </div>
